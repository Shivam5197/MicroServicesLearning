...
import com.Accounts.MicroServiceAccounts.Dto.AccountCreatorInfo;
...
public class AccountController {
    ...
    @Autowired
    private AccountCreatorInfo creatorInfo;
    ...
    public  ResponseEntity<String> getJavaVersion(){
        return
                ResponseEntity.status(HttpStatus.OK).body(env.getProperty("JAVA_Home"));
    }


    @GetMapping("/getContactInfo")
    public  ResponseEntity<AccountCreatorInfo> getAccountCreatorInformation(){
        return
                ResponseEntity
